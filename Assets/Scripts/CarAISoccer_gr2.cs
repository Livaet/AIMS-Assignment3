...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAISoccer_gr2 : MonoBehaviour
    {
        ...
        {
            CarAISoccer_gr2 forwardFriend = friends[0].GetComponent<CarAISoccer_gr2>();
            ...
            {
                forwardFriend = friend.GetComponent<CarAISoccer_gr2>();
                if ((friend.transform.position == transform.position) || (friend.GetComponent<CarAISoccer_gr2>().is_goalie == true))
                {
                    continue;
                }
